...
/****************************************************************************/
/* Define the bit layouts for the AIF protocol specific descriptor*/
/****************************************************************************/
#ifdef _BIG_ENDIAN
typedef struct
{
  /* word 0 */
  Uint32  reserved0   : 16; 	
  Uint32  egress      : 1; /*0: Ingress; 1: Egress*/
  Uint32  symNum      : 8; /*Symbol number*/
  Uint32  axcNum      : 7; /*AxC number (channel number)*/
} AIF_Protocol_Descriptor;
#else
typedef struct
{
  /* word 0 */
